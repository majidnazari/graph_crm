                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="level" name="level" class="form-control" onchange="theChange()">
                                        <option value="">همه</option>
                                        @for($i = 1; $i <= 4; $i++) @if(isset($level) && $level==$i) <option value="{{ $i }}" selected>
                                            @else
                                            <option value="{{ $i }}">
                                                @endif
                                                {{ $i }}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="to_date" name="to_date" class="form-control pdate" value="{{ ($to_date)?jdate($to_date)->format('Y-m-d'):jdate($from_date)->format('Y-m-d')}}" />
                                </div>
                            </div>
                            <!-- <div class="col">
                            <div class="form-group">
